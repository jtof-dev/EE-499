...
\begin{table}[htbp]
\caption{Comprehensive Technical and Functional Comparison of Leading Smart Rings}
\label{tab:combined_ring_comparison}
\centering
\renewcommand{\arraystretch}{1.5} % 1.2 is 20% more space, 1.5 is 50% more
\begin{tabular}{@{}lcccc@{}}
\toprule
\textbf{Feature} & \textbf{Oura Ring 4~\cite{OuraWiki}} & \textbf{Ultrahuman Air~\cite{Ultrahuman}} & \textbf{RingConn Gen 2~\cite{RingConn}} & \textbf{Galaxy Ring~\cite{SamsungRing}} \\ \midrule
\textbf{Sensors}      & PPG, Temp, Accel. & PPG, Temp, 6-axis & PPG, Temp, Accel. & Bio-signal, Temp, Accel. \\
\textbf{Weight}       & 3.3--5.2\,g       & 2.4--3.6\,g       & 2.5--4.0\,g       & $\sim$2.3--3.0\,g \\
\textbf{Battery}      & 5--8 Days         & 4--6 Days         & Up to 10 Days     & $\sim$6--7 Days \\
\textbf{Charging}     & Desktop Dock      & Desktop Dock      & \textbf{Portable Case} & \textbf{Portable Case} \\ \addlinespace
\textbf{Durability}   & 100\,m Water Res. & 100\,m Water Res. & IP68 Rated        & 10ATM / IP68 \\
\textbf{Materials}    & Titanium          & Titanium/Epoxy    & Titanium/Epoxy    & Titanium \\
\textbf{Ecosystem}    & iOS / Android     & iOS / Android     & iOS / Android     & \textbf{Android Only} \\ \addlinespace
\textbf{Key Software} & Readiness/Stress  & Metabolic Health  & AI Partner        & Galaxy AI \\
\textbf{Subscription} & \textbf{Required} & None              & None              & None \\ \bottomrule
\end{tabular}
\\[5pt]
\small{Note: All devices utilize Bluetooth Low Energy (BLE) for connectivity and require a proprietary sizing kit for fitting.}
\end{table}
